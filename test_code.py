...
# token_path = r"/projects/p32234/projects/aihan/MediaLiteracy/results"
...
with open(os.path.join(result_path, f'bertopic_topics.txt'), 'w') as file:
    for class_label in unique_classes:
        ...
        # plotly_fig = topic_model.visualize_documents(class_sub, embeddings=embeddings)
...
with open(f"{result_path}/BERTopic_vis_bar.html", "w") as f:
